...
- **Offline translation** — **M2M-100 418M** (~1 GB) and **M2M-100 1.2B** (~5 GB), both MIT, ~100 languages, run in-process and are selectable/downloadable like any model. Powers cross-language dubbing and translating a transcript (with `.srt` / `.vtt` export) in Transcribe mode.
