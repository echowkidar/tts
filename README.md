...
- **Offline translation** — **M2M-100 418M** (MIT, ~100 languages) and **MADLAD-400 3B** (Apache-2.0, ~400 languages) run in-process and are selectable/downloadable like any model. Powers cross-language dubbing and translating a transcript (with `.srt` / `.vtt` export) in Transcribe mode.
